...
export default function AlertDialogSlide(props) {
  ...
  const ModifierTaux = async (e) => {


    if (sujet <= 100 || sujet >= 0) {
      ...
      setresponse('le taux doit etre compris entre 0 et 100');
      SetOpenfen2(true);
    }
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={ModifierTaux} color="primary">
            Valider
          </Button>
