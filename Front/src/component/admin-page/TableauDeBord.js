      ...
      <div className={classes.backgd}>
        <div className={classes.root}>
          <Paper className={classes.paper1} elevation={20} >
            ...
            <div  >
              <Typography className={classes.title}> Afficher Les Etudiants </Typography>
              <Button component={Link} to="/AfficherEtudiant" className={classes.button1}>Selectionner</Button>
            </div>
          </Paper>
          <Paper className={classes.paper} elevation={20} >
            ...
            <Button component={Link} to="/AfficherEnseignant" className={classes.button1}>Selectionner</Button>
          </Paper>
          <Paper className={classes.paper} elevation={20} >
            <Avatar className={classes.blue}>
              <SubjectOutlined className={classes.blue2} />
            ...
            <Button component={Link} to="/AfficherBinomes" className={classes.button2}>Selectionner</Button>
          </Paper>
