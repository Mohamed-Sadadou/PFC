...
import DatePopUp from '../Commun/DatePopUp';
  ...
  return (
    <div className={classes.all}>
      ...
      <div >
        <div className={classes.root}>
          <Paper className={classes.paper1} elevation={20} >
            ...
            <Typography className={classes.title}>
              Designer la commission de validation
             </Typography>
            <Button component={Link} to="/CreateCommission" className={classes.button}>Selectionner</Button>
        ...
        <Button className={classes.btn} onClick={(e)=>SetOpenfen(true)}>Nouvelle DeadLine</Button>
        <DatePopUp
        OpenFen={OpenFen} 
        SetOpenfen={SetOpenfen} 
        sujet=' Creation de DeadLines ' 
        message={response}
        />
      </div>
    </div>
